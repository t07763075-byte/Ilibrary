...
import 'book_by_genre_controller.dart';

class BookByGenreScreen extends StatefulWidget {
  static const routeName = "BookByGenre";
final CategoryModel category;
  const BookByGenreScreen({super.key, required this.category,});

  @override
  createState() => _BookByGenreScreenState();
}

class _BookByGenreScreenState extends StateX<BookByGenreScreen> {
  _BookByGenreScreenState() : super(controller: BookByGenreController()) {
    con = BookByGenreController();
  }

  late BookByGenreController con;
@override
  void initState() {
    con.init(widget.category);
    super.initState();
  }
  @override
        ...
        child: Column(
          children: [
            ...
            ShowInWidget(
              ...
              onGridView: ()=>setState((){con.isGridView=true;}),
              onListScrollIc: ()=>setState((){con.isGridView=false;}),
            ),
            if (con.isGridView)
              Expanded(
                child: Visibility(
                      ...
                      builder: (context, constraints) {
                        ...
                        return PaginationWidget(
                          ...
                          child: GridView.builder(
                            ...
                            itemCount: con.bookPagination.data.length, // Number of items in the grid
                  ...
                  child: Visibility(
                    ...
                    replacement: PaginationWidget(
                      ...
                      child: ListView.separated(
                          padding:
                              EdgeInsets.symmetric(horizontal: 24.w, vertical: 16.h),
                          itemBuilder: (_, index) => VerticalHomeItemWidget(book: con.bookPagination.data[index],),
