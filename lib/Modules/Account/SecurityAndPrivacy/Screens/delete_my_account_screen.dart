...
class DeleteMyAccountScreen extends StatefulWidget {
  static const routeName="deleteMyAccountScreen";
  const DeleteMyAccountScreen({super.key});

  @override
   createState() => _DeleteMyAccountScreenState();
}

class _DeleteMyAccountScreenState extends StateX<DeleteMyAccountScreen> {
  _DeleteMyAccountScreenState():super(controller:SecurityAndPrivacyController() ){
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: CustomAppBarWidget.detailsScreen(
        screenName: Strings.deleteMyAccount.tr,
      ),
      body: LoadingScreen(
        loading: con.loading,
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Gap(32.h),
              Text(Strings.enterPasswordConfirmDeleteAccount.tr,style: TextStyleHelper.of(context).s18RegTextStyle,),
              Gap(24.h),
              Text(
                Strings.password.tr,
              ...
              CustomTextFieldWidget(
                ...
                onSuffixTap: ()=> setState(()=> con.isPasswordVisible = !con.isPasswordVisible),
              ),
              const Spacer(),
              Container(
