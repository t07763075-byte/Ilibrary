...
class ChangePhoneNumberSuccessWidget extends StatelessWidget {
  const ChangePhoneNumberSuccessWidget({Key? key,}) : super(key: key);
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Gap(32.h),
          Text(
            Strings.successfulPhoneChange.tr,
          ...
          Gap(16.h),
          Text(
            Strings.phoneChangedSuccessfully.tr,
