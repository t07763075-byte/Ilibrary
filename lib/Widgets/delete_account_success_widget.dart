...
import '../Modules/Account/LogOut/logout_controller.dart';

class DeleteAccountSuccessWidget extends StatelessWidget {
  const DeleteAccountSuccessWidget({Key? key,}) : super(key: key);
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Gap(32.h),
          Text(
            Strings.accountPermanentlyDeleted.tr,
          ...
          Gap(16.h),
          Text(
            Strings.accountDeletedSuccessfully.tr,
